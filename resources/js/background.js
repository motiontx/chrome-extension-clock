...
const drawSky = () => {
  // Based on -> https://codepen.io/AlienPiglet/pen/hvekG
...
const reset = () => {
  ...
  let ballsAmount = (width + height) * 0.015;
  let BallsAmountTop = Math.floor(ballsAmount*0.33);
  let BallsAmountBot = Math.floor(ballsAmount*0.66);
  systemTop = new ParticleSystem(BallsAmountTop, ctxTop, colorsTop, 40, 40);
  systemBot = new ParticleSystem(BallsAmountBot, ctxBot, colorsBot, 20, 8);
  drawSky();
}
